...
game.o: game.c ./drivers/avr/system.h ./utils/tinygl.h ./drivers/display.h ./fonts/font3x5_1.h ./utils/font.h ./drivers/avr/timer.h ./drivers/navswitch.h lights.h setupGame.h
	$(CC) -c $(CFLAGS) $< -o $@
...
game.out: game.o lights.o setupGame.o pio.o system.o timer.o button.o display.o ledmat.o font.o pacer.o tinygl.o ir_uart.o prescale.o timer0.o usart1.o navswitch.o task.o
	$(CC) $(CFLAGS) $^ -o $@ -lm
	$(SIZE) $@
